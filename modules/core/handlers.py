...
class CoreModule(BotModule):
    ...
    default_messages = {
        ...
        "faq_dates": "📅 Сроки акции\n\n🟢 Начало: {start}\n🔴 Окончание: {end}\n\n📅 Ежемесячные розыгрыши\n🏆 Финальный — в конце акции",
        "faq_prizes": "🎁 Призы\n\n{prizes}\n\n📅 Ежемесячные призы\n🏆 Главные — в финале",
        "faq_raffle": "🎲 Как работают розыгрыши?\n\n📅 ЕЖЕМЕСЯЧНЫЙ:\n• Участвуют билеты за месяц\n• После розыгрыша — обнуляются\n• Меньше участников = выше шанс\n\n🏆 ФИНАЛЬНЫЙ:\n• ВСЕ ваши билеты за всё время\n• Главные призы\n• Чем больше копите — тем лучше!",
    ...
    def _setup_handlers(self):
        ...
        async def show_my_tickets(message: Message, bot_id: int = None):
            ...
            text += "📅 Ежемесячный розыгрыш:\n"
            text += "  • Участвуют билеты за месяц\n"
            text += "  • После — обнуляются\n\n"
            
            text += "🏆 Финальный розыгрыш:\n"
            text += "  • ВСЕ билеты за всё время\n"
