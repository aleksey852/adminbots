...
class PromoModule(BotModule):
    ...
    default_messages = {
        "promo_prompt": "🎁 Введи промокод с упаковки 👇",
        "promo_ended": "🏁 Акция завершена",
        "promo_wrong_format": "⚠️ Код должен быть 12 символов\nТы ввёл: {length}\n\n💡 Пример: ABCD12345678",
        "promo_invalid_chars": "⚠️ Только буквы и цифры!",
        "promo_not_found": "❌ Код не найден. Проверь и попробуй ещё раз",
        "promo_already_used": "⚠️ Этот код уже использован. Попробуй другой!",
        "promo_db_error": "⚠️ Что-то пошло не так. Попробуй позже",
        "promo_activated": "🎉 Отлично! +{tickets} билет!\n\n🎫 Всего: {total} билетов\n📈 Твой шанс вырос!\n\n💡 Ещё код? Просто отправь сюда 👇",
        "promo_activation_error": "❌ Ошибка активации. Попробуй ещё раз",
    }
